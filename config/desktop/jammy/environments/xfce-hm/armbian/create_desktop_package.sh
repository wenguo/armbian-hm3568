...
cp "${SRC}"/packages/bsp/hemai/background.png "${destination}"/usr/share/backgrounds/armbian
...
cp "${SRC}"/packages/bsp/hemai/roymark*.png "${destination}"/usr/share/pixmaps/armbian
